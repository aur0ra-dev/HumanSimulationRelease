...
public class ProgressStudents {
    ...
    /**
     * Metoda dzieki petli generuje wynik dla kazdego kolejnego obiektu listToExaminete na podstawie jego pol
     * @param listToExaminate lista obiektow ktore sa wykorzystywane w metodzie
     * @param highSchool obiekt klasy Highl scool
     * @return zwraca sredni wynik
     */
