...
public class Simulation {
    ...
    /**
     * Glowna metoda Symulacji odpowiedzialna za wydarzenia dziala na podstawie petli oraz switcha
     * w kazdym z casow modifykowanwa sa odpowiednie pola obiektu oraz inicjalizowane Miejsca(places)
     */
        ...
        for(int i = 0; mainCharacter.age < duration; i++){
            switch (i) {
                ...
                case 3 -> {
                    ...
                    kindergarten.initializePlace(mainCharacter, kindergarten.numberOfTeachers, kindergarten.listOfTeachers);
                ...
                case 6 -> {
                    ...
                    kindergarten = null;
                    primaryschool.initializePlace(mainCharacter, primaryschool.numberOfTeachers, primaryschool.listOfTeachers);
                ...
                case 14 -> {
                    ...
                    comparator.showcase(comparator.strengthDif, comparator.intelligenceDif,comparator.wisdomDif, comparator.charismaDif, mainCharacter.age);
                    primaryschool = null;
                    highschool.initializePlace(mainCharacter, highschool.numberOfTeachers, highschool.listOfTeachers);
                ...
                case 18 -> {
                    ...
                    highschool = null;
                    college.initializePlace(mainCharacter, college.numberOfTeachers, college.listOfTeachers);
    ...
    /**
     * metoda odpowiedziala za sprawdzanie czy symulacja dobiegla konca
     *
     */
